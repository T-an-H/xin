...
export const students: Student[] = [
  { id: 'stu-1', studentId: 'S2024001', name: '张明', className: '软件工程一班', phone: '138****1234', email: 'zhangming@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=zhangming', joinDate: '2026-06-01', status: 'active', enrollmentScore: 645 },
  { id: 'stu-2', studentId: 'S2024002', name: '李华', className: '软件工程一班', phone: '139****5678', email: 'lihua@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=lihua', joinDate: '2026-06-03', status: 'active', enrollmentScore: 580 },
  { id: 'stu-3', studentId: 'S2024003', name: '王芳', className: '软件工程一班', phone: '137****9012', email: 'wangfang@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=wangfang', joinDate: '2026-06-05', status: 'active', enrollmentScore: 620 },
  { id: 'stu-4', studentId: 'S2024004', name: '赵磊', className: '软件工程一班', phone: '136****3456', email: 'zhaolei@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=zhaolei', joinDate: '2026-06-08', status: 'active', enrollmentScore: 550 },
  { id: 'stu-5', studentId: 'S2024005', name: '陈静', className: '软件工程一班', phone: '135****7890', email: 'chenjing@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=chenjing', joinDate: '2026-06-10', status: 'active', enrollmentScore: 670 },
  { id: 'stu-6', studentId: 'S2024006', name: '刘洋', className: '软件工程一班', phone: '134****2345', email: 'liuyang@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=liuyang', joinDate: '2026-06-12', status: 'active', enrollmentScore: 530 },
  { id: 'stu-7', studentId: 'S2024007', name: '孙丽', className: '软件工程一班', phone: '133****6789', email: 'sunli@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=sunli', joinDate: '2026-06-15', status: 'active', enrollmentScore: 600 },
  { id: 'stu-8', studentId: 'S2024008', name: '周杰', className: '软件工程一班', phone: '132****0123', email: 'zhoujie@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=zhoujie', joinDate: '2026-06-18', status: 'inactive', enrollmentScore: 480 },
  { id: 'stu-9', studentId: 'S2024009', name: '吴婷', className: '软件工程一班', phone: '131****4567', email: 'wuting@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=wuting', joinDate: '2026-06-20', status: 'active', enrollmentScore: 610 },
  { id: 'stu-10', studentId: 'S2024010', name: '郑凯', className: '软件工程一班', phone: '130****8901', email: 'zhengkai@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=zhengkai', joinDate: '2026-06-22', status: 'active', enrollmentScore: 520 },
  { id: 'stu-11', studentId: 'S2024011', name: '黄丽', className: '软件工程一班', phone: '159****2345', email: 'huangli@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=huangli', joinDate: '2026-06-25', status: 'active', enrollmentScore: 640 },
  { id: 'stu-12', studentId: 'S2024012', name: '林伟', className: '软件工程一班', phone: '158****6789', email: 'linwei@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=linwei', joinDate: '2026-06-28', status: 'active', enrollmentScore: 500 },
  { id: 'stu-13', studentId: 'S2024013', name: '何雪', className: '软件工程一班', phone: '157****0123', email: 'hexue@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=hexue', joinDate: '2026-07-01', status: 'active', enrollmentScore: 665 },
  { id: 'stu-14', studentId: 'S2024014', name: '马强', className: '软件工程一班', phone: '156****4567', email: 'maqiang@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=maqiang', joinDate: '2026-07-03', status: 'inactive', enrollmentScore: 460 },
  { id: 'stu-15', studentId: 'S2024015', name: '胡敏', className: '软件工程一班', phone: '155****8901', email: 'humin@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=humin', joinDate: '2026-07-05', status: 'active', enrollmentScore: 590 },
  { id: 'stu-16', studentId: 'S2024016', name: '高飞', className: '软件工程一班', phone: '154****2345', email: 'gaofei@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=gaofei', joinDate: '2026-07-08', status: 'active', enrollmentScore: 565 },
  { id: 'stu-17', studentId: 'S2024017', name: '欧阳雪', className: '软件工程一班', phone: '153****1234', email: 'ouyangxue@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=ouyangxue', joinDate: '2026-07-10', status: 'active', enrollmentScore: 685 },
  { id: 'stu-18', studentId: 'S2024018', name: '慕容枫', className: '软件工程一班', phone: '152****5678', email: 'murongfeng@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=murongfeng', joinDate: '2026-07-12', status: 'active', enrollmentScore: 630 },
  { id: 'stu-19', studentId: 'S2024019', name: '令狐冲', className: '软件工程一班', phone: '151****9012', email: 'linghuchong@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=linghuchong', joinDate: '2026-07-14', status: 'active', enrollmentScore: 590 },
  { id: 'stu-20', studentId: 'S2024020', name: '杨过', className: '软件工程一班', phone: '150****3456', email: 'yangguo@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=yangguo', joinDate: '2026-07-16', status: 'active', enrollmentScore: 540 },
  { id: 'stu-21', studentId: 'S2024021', name: '小龙女', className: '软件工程一班', phone: '149****7890', email: 'xiaolongnv@example.com', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=xiaolongnv', joinDate: '2026-07-18', status: 'active', enrollmentScore: 610 },
];
...
export const grades: Grade[] = [
  { id: 'g-1', studentId: 'stu-1', courseId: 'course-1', score: 88, totalScore: 88, semester: '2026年春季', comment: '表现优秀', gradedAt: '2026-07-15' },
  { id: 'g-2', studentId: 'stu-2', courseId: 'course-1', score: 92, totalScore: 92, semester: '2026年春季', comment: '非常好', gradedAt: '2026-07-15' },
  { id: 'g-3', studentId: 'stu-3', courseId: 'course-2', score: 75, totalScore: 75, semester: '2026年春季', comment: '需要加强练习', gradedAt: '2026-07-16' },
  { id: 'g-4', studentId: 'stu-4', courseId: 'course-2', score: 80, totalScore: 80, semester: '2026年春季', comment: '良好', gradedAt: '2026-07-16' },
  { id: 'g-5', studentId: 'stu-5', courseId: 'course-3', score: 85, totalScore: 85, semester: '2026年春季', comment: '设计感不错', gradedAt: '2026-07-17' },
  { id: 'g-6', studentId: 'stu-8', courseId: 'course-5', score: 95, totalScore: 95, semester: '2026年春季', comment: '优秀学员', gradedAt: '2026-07-17' },
  { id: 'g-7', studentId: 'stu-14', courseId: 'course-3', score: 70, totalScore: 70, semester: '2026年春季', comment: '继续努力', gradedAt: '2026-07-15' },
  { id: 'g-8', studentId: 'stu-15', courseId: 'course-1', score: 90, totalScore: 90, semester: '2026年春季', comment: '很棒', gradedAt: '2026-07-16' },
  { id: 'g-9', studentId: 'stu-1', courseId: 'course-14', score: 86, totalScore: 86, semester: '2026年春季', comment: '具备较好的应用理解能力', gradedAt: '2026-07-22' },
  { id: 'g-10', studentId: 'stu-1', courseId: 'course-15', score: 91, totalScore: 91, semester: '2026年春季', comment: '数据分析能力突出', gradedAt: '2026-07-22' },
  { id: 'g-11', studentId: 'stu-1', courseId: 'course-16', score: 78, totalScore: 78, semester: '2026年春季', comment: '表达较清晰，继续加强节奏控制', gradedAt: '2026-07-23' },
  { id: 'g-12', studentId: 'stu-17', courseId: 'course-14', score: 82, totalScore: 82, semester: '2026年春季', comment: '应用能力较好，继续深入', gradedAt: '2026-07-25' },
  { id: 'g-13', studentId: 'stu-19', courseId: 'course-3', score: 76, totalScore: 76, semester: '2026年春季', comment: '设计基础扎实', gradedAt: '2026-07-24' },
  { id: 'g-14', studentId: 'stu-18', courseId: 'course-15', score: 88, totalScore: 88, semester: '2026年春季', comment: '数据分析能力出色', gradedAt: '2026-07-25' },
];
